!function () {
    ...
    function c(c, d) {
        ...
        var g = d.debug, h = d.openTag, i = d.closeTag, j = d.parser, k = d.compress, l = d.escape, m = 1, p = {
                ...
                ');',
                '$out.join(\'\')'
            ], t = q ? '$out+=text;return $out;' : '$out.push(text);', u = 'function(){var text=\'\'.concat.apply(\'\',arguments);' + t + '}', v = 'function(filename,data){data=data||$data;var text=$utils.$include(filename,data,$filename);' + t + '}', w = '\'use strict\';var $utils=this,$helpers=$utils.$helpers,' + (g ? '$line=0,' : ''), x = s[0], y = 'return new String(' + s[3] + ');';
