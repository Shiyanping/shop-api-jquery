    ...
    MobileArea.prototype = {
        ...
        bindEvent: function () {
            ...
            function popupArea(e) {
                var area_btn_left_str = '<div class="area_btn_left news">遇到问题</div>';
                var larea_finish_str = '<div class="area_btn larea_finish news">确定</div></div>';
                var area_tips_success_str = '<div class="area_tips_item area_tips_success news">确定</div>';
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    area_btn_left_str +
                    '<div class="area_btn_right"><div class="area_btn larea_cancel">取消</div>' +
                    larea_finish_str +
                    '</div>' +
                    ...
                    '</div>' +
                    '<div class="area_tips">' +
                    '<div class="area_tips_bg"></div>' +
                    '<div class="area_tips_box">' +
                    '<div class="area_tips_title">选择地址遇到问题？</div>' +
                    '<div class="area_tips_point">在此手动填写</div>' +
                    '<div class="area_tips_input"><input placeholder="请输入 省-市-区(县)" type="text"></div>' +
                    '<div class="area_tips_btn">' +
                    '<div class="area_tips_item area_tips_cancel">取消</div>' +
                    area_tips_success_str +
                    '</div>' +
                    '</div>' +
                    '</div>';;
                ...
                // 后续开发添加
                $('.area_btn_left').click(function () {
                    $('.area_tips').show();
                    $('.area_tips_input input').focus();
                });
                // 关闭按钮
                $('.area_tips_cancel').click(function () {
                    $('.area_tips').hide();
                });
                // 确认
                $('.area_tips_success').click(function () {
                    var val = $('.area_tips_input input').val().replace(/\s/g, '');
                    if (val === '') {
                        $('.area_tips').hide();
                        _self.close(e);
                    } else {
