...
module.exports = {
    ...
    // 单路径整体build【String】
    buildPath:'/Users/syp/Documents/workspace/mall-api',
    // buildPath:'./mall-api',
...
/*    buildPath: {
        ...
        '.js': '/Users/lijialong/Documents/codefollow/src/main/webapp/js',
        '.css': '/Users/lijialong/Documents/codefollow/src/main/webapp/css',
        '.jpg|.jpeg|.gif|.png|.ico': '/Users/lijialong/Documents/codefollow/src/main/webapp/images',
        '.html': '/Users/lijialong/Documents/codefollow/src/main/webapp/template'
    },*/
...
/*        links: {
    ...
    mockTemplate: path.join( webContent, secondary, 'mock/velocity' ),
    ...
    middlewares: function( connect, options, middlewares, rtool ) {
        ...
        middlewares.unshift( function( req, res, next ) {
            // 省着一直转圈
            if ( ~ req.url.indexOf( 'company-index/top_info/img/icon.png' )
               || ~ req.url.indexOf( 'company-index/top_info/img/logo.jpg' ) ) {
                res.end( '' );
            }
            return next();
        } );
